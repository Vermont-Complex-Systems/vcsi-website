...
export const getOpenAlexAuthor = prerender('unchecked', async (openAlexId) => {
...
export const getMemberWithOpenAlex = prerender('unchecked', async (slug) => {
...
export const getAuthorPapers = prerender('unchecked', async (openAlexId) => {
